...
function NavbarStudent({setSelection,setCompanyId}) {
    ...
    return (
        <div className="fixed w-64 h-screen bg-gradient-to-b from-slate-800 via-slate-900 to-slate-900 text-white p-5 shadow-2xl overflow-y-auto z-50">
            ...
            <nav className="space-y-1">
                <div onClick={()=>{setSelection("Dashboard"); setCompanyId(null)}} 
                className="flex items-center p-3 rounded-lg bg-gradient-to-r from-blue-700/20 to-indigo-700/20 backdrop-blur-sm border border-blue-600/20 shadow-sm">
                ...
                <div onClick={()=>{setSelection("MyProfile"); setCompanyId(null)} }
